...
BUILD_FOLDER="../build_release_dyn"

echo ""
echo " ==================================== "
echo "   Running cmake (configuration)"
echo " ==================================== "
cmake -S . -B "$BUILD_FOLDER"  -DCMAKE_BUILD_TYPE=RelWithDebInfo  -DMODULES_BUILD_STATIC=OFF  -DMUSE_ENABLE_ASAN=OFF
